...
namespace Aps.Domain.Account.Tests
{
    ...
    public partial class AccountId_identity
    {
        ...
        {
            var first = new AccountId(new CompanyName("Acme Ltd"), new AccountNumber("1234567890"));
            var second = new AccountId(new CompanyName("JCSE Ltd"), new AccountNumber("1234567890"));
        ...
        {
            var first = new AccountId(new CompanyName("Acme Ltd"), new AccountNumber("1234567890"));
            var second = new AccountId(new CompanyName("Acme Ltd"), new AccountNumber("0987654321"));
