...
namespace Aps.Domain
{
    ...
    public static class Guard
    {
        ...
        public static void ThatParameterNotNull<T>(T value, string paramName) where T : class
        {
            if (value == null)
        ...
        public static void ThatParameterNotNullOrEmpty(string value, string paramName)
        {
            ThatParameterNotNull(value, paramName);
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="value"/> is null or whitespace.</exception>
        public static void ThatParameterNotNullOrEmpty(string value, string paramName, string message)
        {
            ThatParameterNotNull(value, paramName);
        ...
        /// <param name="paramName">Name of the param.</param>
        public static void ThatParameterNotNullOrEmpty<T>(IEnumerable<T> sequence, string paramName)
        {
            // ReSharper disable PossibleMultipleEnumeration
            ThatParameterNotNull(sequence, paramName);
            ThatParameterCondition(sequence.Any(), paramName, String.Format("Paramter {0} may not be empty.", paramName));
        ...
        public static void ThatParameterCondition(bool condition, string paramName)
        {
            if (!condition)
        ...
        /// <exception cref="ArgumentException">If the condition is false.</exception>
        public static void ThatParameterCondition(bool condition, string paramName, string message)
        {
            if (!condition)
                throw new ArgumentException(message, paramName);
        }
